...
export default function AdminPanel() {
  ...
  const handleAddOrUpdate = async () => {
    ...
    const updatedLink = { 
      ...newLink, 
      name: newLink.name.trim() || 'Admin' // Default to "Admin" if empty
    }

    if (editingIndex !== null) {
      updatedLinks = links.map((link, index) =>
        index === editingIndex ? updatedLink : link
      )
      ...
      <div className='row g-2 my-4'>
        <div className='col-12 col-sm-4'>
          <input
            ...
            placeholder='Admin Name (default: Admin)'
        ...
        <div className='col-12 mt-2'>
          <button onClick={handleAddOrUpdate} className='btn btn-primary w-100'>
